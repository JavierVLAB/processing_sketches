...
void drawSkeleton(int userId)
{
  ...
  context.getJointPositionSkeleton(userId,SimpleOpenNI.SKEL_HEAD,jointPosPru);
  context.getJointPositionSkeleton(userId,SimpleOpenNI.SKEL_NECK,jointPosPru2);
  float abc = dist(jointPosPru2.x,jointPosPru2.y,jointPosPru2.z,jointPosPru.x,jointPosPru.y,jointPosPru.z);
  
  pushMatrix();
  fill(255);
  translate(jointPosPru.x,jointPosPru.y,jointPosPru.z);
  sphere(abc/2);
  popMatrix();
