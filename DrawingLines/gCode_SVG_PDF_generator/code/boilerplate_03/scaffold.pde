 ...
 */
final int CONFIG_PRINT_WIDTH_MM = 160;
final int CONFIG_PRINT_HEIGHT_MM = 160;
final String CONFIG_GCODE_PEN_UP = "G0 Z4.0\n"; // "M03 S0\n";
final String CONFIG_GCODE_PEN_DOWN = "G0 Z0.15\n";//"M03 S20\n";
final String CONFIG_GCODE_MOVE_FEEDRATE = "1000";
final String CONFIG_GCODE_RAPID_FEEDRATE = "8000";
